...
function iniciarApp(){
    ...
    botonesPaginador();  // muestra y oculta botones del paginador
    paginaAnterior();
    paginaSiguiente();
...
function seleccionarServicio(servicio){
    ...
    //compbrobar si un servicio ya fue agregado
...
function mostrarResumen() {
   ...
   //deading para servicios en resumen
...
async function reservarCita() {
    ...
    if(resultado.resultado) {
        ...
        icon: "error",
        title: "Error",
        text: "Algo salió mal al intentar crear la cita",
